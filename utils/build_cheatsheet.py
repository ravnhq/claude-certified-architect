...
.panel { background: var(--surface); border: 1px solid var(--border); border-radius: var(--r-md); padding: 22px 24px; }
.panel h4 { margin: 0 0 16px; font-size: 11px; letter-spacing: .14em; text-transform: uppercase; color: var(--muted);
...
RAVN_LOGO_SVG = (
  '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 148 33" aria-label="Ravn" role="img" '
...
TOPBAR = ('<header class="ravn-topbar"><a class="ravn-brand" href="../index.html" '
  'aria-label="Ravn — Claude Certified Architect">' + RAVN_LOGO_SVG +
