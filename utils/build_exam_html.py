...
.q-btn.answered-correct { color: var(--gold); }
.q-btn.answered-correct .q-dot { background: var(--gold); }
...
.option.correct { border-color: var(--gold); background: var(--gold-soft); }
.option.correct .opt-letter { background: var(--gold); color: var(--gold-fg); }
...
.option.correct .opt-expl { color: var(--gold); }
...
.score-card.correct-c .big { color: var(--gold); }
...
.wi-correct-tag { color: var(--gold); font-weight: 700; }
